<template>
  ...
  <v-app-bar class="pa-0 border-b pr-5 bg-surface" :color="name == 'dark' ? '' : 'primary'" :model-value="!hideBar" density="compact" flat
    v-if="user">
      <v-btn size="small" style="opacity: .8;" class="text-capitalize rounded-lg mr-2 font-weight-regular"
        @click="$router.push({ name: 'r-access-home' })" prepend-icon="mdi-home">Home</v-btn>
      <v-btn size="small" style="opacity: .8;" class="text-capitalize rounded-lg mr-2 font-weight-regular"
        prepend-icon="mdi-square-edit-outline" :to="{ name: 'r-access-projects' }">Projects</v-btn>
      <v-btn size="small" style="opacity: .8;" class="text-capitalize rounded-lg mr-2 font-weight-regular"
        prepend-icon="mdi-calendar" :to="{ name: 'r-access-schedules' }">Schedules</v-btn>
      <v-btn :to="{ name: 'r-access-statistics' }" size="small" style="opacity: .8;"
        class="text-capitalize rounded-lg mr-2 font-weight-regular" prepend-icon="mdi-chart-arc">Statistics</v-btn>
      <v-spacer></v-spacer>
