<template>
    <div>
        ...
        <v-app-bar class="d-flex  align-center text-white border-b" density="compact"
            ...
            <v-app-bar-nav-icon class="rounded-0 "
                @click="showRightNavigation = !showRightNavigation"></v-app-bar-nav-icon>
            ...
            <v-btn @click="viewMode = 'monthly'" :variant="viewMode == 'monthly' ? 'flat' : 'tonal'"
                class="text-capitalize mr-2" size="small">Monthly</v-btn>
            <v-btn @click="viewMode = 'weekly'" :variant="viewMode == 'weekly' ? 'flat' : 'tonal'"
                class="text-capitalize mr-2" size="small">Weekly</v-btn>
            <v-btn @click="viewMode = 'daily'" :variant="viewMode == 'daily' ? 'flat' : 'tonal'"
                class="text-capitalize mr-2" size="small">Daily</v-btn>
            <v-btn size="x-small" variant="tonal" class="rounded-lg mr-2" icon="mdi-chevron-right"
                @click="increaseDate"></v-btn>

            <v-spacer></v-spacer>
            <v-btn size="small" variant="flat" class=" mr-2 text-capitalize" prepend-icon="mdi-plus" color="primary"
                @click="showAddScheduleDialog = true">Create Schedule</v-btn>
        ...
        <v-main class="h-screen">
            ...
            <schedule-dialog-edit :show-dialog="!!$route.query.edit && !!schedule"
                :key="schedule?._id || 'null'"></schedule-dialog-edit>
